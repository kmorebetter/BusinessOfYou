        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-8">
          ...
          <div className="max-w-[851px] mx-auto px-4 sm:px-6">
            <div className="space-y-16 mb-20">
              <section>
                <h2 className={`${playfair.className} uppercase text-xl lg:text-2xl font-normal text-[#202329] mb-6 tracking-wide`}>Latest Video</h2>
              ...
              <section>
                <h2 className={`${playfair.className} uppercase text-xl lg:text-2xl font-normal text-[#202329] mb-6 tracking-wide`}>Featured Article</h2>
                <p className={`${lora.className} text-base lg:text-lg text-[#40434A] leading-[1.8] font-normal mb-12`}>
              ...
              <section>
                <h2 className={`${playfair.className} uppercase text-xl lg:text-2xl font-normal text-[#202329] mb-6 tracking-wide`}>Newsletter</h2>
                <p className={`${lora.className} text-base lg:text-lg text-[#40434A] leading-[1.8] font-normal mb-12`}>
